...
%T_loiter=0 % Temps d'attente en minute 
%Fuel_res=0.05 % Fraction d'essence avant l'atterrisage (de réserve)
%Fuel_trap=0.01 % Fraction d'essence dans les conduites (trapped)
...
% ---------------------------------------------------------------------
% trouver la valeur de Wto dans un intervalle
