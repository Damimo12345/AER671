function [d d0 cd0] = trainee_aile(M, H, fleche_le, S, A, epais_rel, ...
...
% coefficient k
% ---------------------------------------------------------------------
k= 1/(pi*A*e_oswald(A)); % Veillez à bien changer la constante e_oswald à 0.95 pour qu'elle soit représentative de l'efficacité d'envergure pour l'application à l'aile seule.
